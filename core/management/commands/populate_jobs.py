...
class Command(BaseCommand):
    ...
    def _create_employers(self):
        ...
        if not admin_password:
            ...
            self.stdout.write(self.style.WARNING(f'Generated random admin password: {admin_password}'))
            self.stdout.write(self.style.WARNING('Please save this password or set DEMO_ADMIN_PASSWORD env variable.'))
        ...
        employer_password = os.environ.get('DEMO_EMPLOYER_PASSWORD')
        if not employer_password:
            employer_password = self._generate_secure_password()
            self.stdout.write(self.style.WARNING(f'Generated random employer password: {employer_password}'))
            self.stdout.write(self.style.WARNING('Please save this password or set DEMO_EMPLOYER_PASSWORD env variable.'))
